...
/**
 * <p>Java class for MyBiblioItemType complex type.
 * 
 ...
 *         &lt;element name="citedBy" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "MyBiblioItemType", propOrder = {
    "author",
    "title",
    "subtitle",
    "citedBy"
...
public class MyBiblioItemType {
    ...
    protected List<Integer> citedBy;
     ...
     * 
     */
    public List<Integer> getCitedBy() {
        if (citedBy == null) {
            citedBy = new ArrayList<Integer>();
        }
        return this.citedBy;
    }
